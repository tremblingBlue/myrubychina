"""
Django settings for myrubychina project.
...
SECRET_KEY = 'r)((6gt2s1^!ut_^jq3^#+_*wk!*_(hep0oa6@l*8e$=(5m$&c'
...
INSTALLED_APPS = [
    'rubychina.apps.RubychinaConfig',
...
WSGI_APPLICATION = 'myrubychina.wsgi.application'
